...
@RestController
public class AllUserBookingsController {
    private final BookingRepository bookingRepository;
    private final UserRepository userRepository;
    private final RoomRepository roomRepository;

    public AllUserBookingsController(BookingRepository bookingRepository, UserRepository userRepository, RoomRepository roomRepository) {
    ...
    @GetMapping("/history")
    public ResponseEntity<?> getAllUserBookings(@RequestParam("userID") int userID) {
        ...
        List<Object> bookingsHistory = allBookings.stream()
                .filter(booking -> booking.getUserId() == userID)
                .filter(booking -> {
                ...
                .map(booking -> {
                    ...
                    return new Object() {
                        ...
                        public final Date dateOfBooking = booking.dateOfBooking;
        ...
        return ResponseEntity.ok(bookingsHistory);
    }
