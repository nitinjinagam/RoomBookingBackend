...
public class LoginController {
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequest loginRequest) {
        ...
        if (!user.getPassword().equals(loginRequest.getPassword())) {
            ...
            return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(new ErrorDTO("Username/Password Incorrect"));
        }

        // If the user exists and the password is correct, return a 200 OK response with success message
